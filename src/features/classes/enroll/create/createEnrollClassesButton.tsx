import { useEnrollClasses } from '~/src/entities/class/enroll/enroll-classes';
...
export function CreateEnrollClassesButton({
  ...
  return (
    <button
      className="w-full bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 disabled:text-gray-600 disabled:cursor-not-allowed disabled:opacity-50 text-white font-medium py-2 px-4 rounded-md transition-colors duration-200 cursor-pointer"
